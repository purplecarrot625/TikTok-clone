...
// to specify what the postDetails are
interface IProps {
  postDetails: Video;
}
// { } means destructure
...
}, [post, isVideoMuted]) // If we go to a different detail page, we have to run it to check if it is muted
    
// - HANDLE LIKE FUNCTIONAL - {} means destructure
  ...
  return (
    <div className="flex w-full absolute left-0 top-0 bg-white flex-wrap lg:flex-nowrap">
      ...
      <div className="relative flex-2 w-[1000px] lg:w-9/12 flex justify-center items-center bg-blurred-img bg-no-repeat bg-cover bg-center">
        ...
        {/** CANCEL BUTTON, press and go back */}
        ...
        <div className="absolute bottom-5 lg:bottom-10 right-5 lg:right-10 cursor-pointer"> 
            {isVideoMuted ? (
                <button onClick={()=> setIsVideoMuted(false)}>
                    <HiVolumeOff className="text-white texl-2xl lg:text-4xl" />
                </button>
            ): (
